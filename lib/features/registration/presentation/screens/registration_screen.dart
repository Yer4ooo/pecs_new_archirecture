        ...
        body: SafeArea(
          child: BlocConsumer<RegistrationBloc, RegistrationState>(
            ...
            builder: (context, state) {
              return Padding(
                padding: EdgeInsets.only(left: 25.h, top: 25.w, right: 40.w, bottom: 25.h),
                child: Row(
                                ...
                                child: Column(
                                  children: [
                                    Text("Создать аккаунт",
                                        style: GoogleFonts.inter(
                                            fontSize: 20.sp, fontWeight: FontWeight.w600, color: AppColors.black)),
                                    20.verticalSpace,
                                    SegmentedTabBar(
...
class SegmentedTabBar extends StatelessWidget {
  ...
  Widget _buildTab(UserRole role, String label, {bool isFirst = false, bool isLast = false}) {
