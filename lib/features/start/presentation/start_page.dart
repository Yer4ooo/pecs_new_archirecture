...
import '../../../core/components/show_error.dart';
                    ...
                    children: [
                      ...
                      BlocConsumer<LoginBloc, LoginState>(
                        ...
                        if (state is LoginSuccess) {
                          ...
                          if (state.message.message.isNotEmpty) {
                            showError(context, state.message.message);
                          }
                        }
                            ...
                            child: Column(
                                ...
                                children: [
                                    ...
                                    suffixIcon: Padding(
                                      ...
                                      child: GestureDetector(
                                        ...
                                        child: SvgPicture.asset(
                                          _isPasswordVisible
                                              ? AppIcons
                                                  .showPassword // Use appropriate show icon
                                  ...
                                  PrimaryButton(
                                    ...
                                    loadingText: "${LocaleKeys.login_page_logging.tr()}...", // or hardcode "Logging in..."
